...
export default function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-[#244934] text-white shadow-md border-b border-[#356147]">
        {/* Top announcement bar */}
        <div className="bg-[#1a3526] text-xs py-1.5 px-4 text-emerald-100 flex justify-between items-center border-b border-[#2d523c]">
          ...
          <div className="flex items-center gap-4">
            <a href="tel:+998909998877" className="flex items-center gap-1 hover:text-amber-300 transition-colors">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden p-2 text-emerald-100 hover:text-amber-300 focus:outline-none"
        ...
        {/* Mobile dropdown */}
        {mobileMenuOpen && (
          <div className="lg:hidden bg-[#1a3526] border-t border-[#2d523c] px-4 py-4 space-y-3 animate-fadeIn">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
